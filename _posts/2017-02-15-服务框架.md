...
![不含服务框架的](/assets/image/ServiceFramework/image0.png)

如果加入服务框架后：

![含服务框架的](/assets/image/ServiceFramework/image1.png)
...
![服务框架要解决的问题](/assets/image/ServiceFramework/image2.png)
...
![含服务注册查找中心的](/assets/image/ServiceFramework/image_center.png)
...
![NIO Client示例](/assets/image/ServiceFramework/image_nio_client.png)
...
![Callback方式](/assets/image/ServiceFramework/image_callback.png)

Future方式的图示如下：

![Future方式](/assets/image/ServiceFramework/image_future.png)
